...
public interface ServicioDisponibilidadProfesor {
    ...
    void toggleDisponibilidadConFecha(String emailProfesor, String diaSemana, String hora, LocalDate fechaEspecifica);
    ...
    List<disponibilidadProfesor> obtenerDisponibilidadProfesorPorSemana(String email, LocalDate fechaInicioSemana);
